...
public class LinesTest extends TestCase {
  ...
  public void testEmpty() {
    assertEquals("line 3", ILineCoverage.NO_CODE, lines.getCoverage(3));
  }

  public void testBeforeFirstLine() {
    lines.addLines(new int[] { 1000 }, true);
    assertEquals("line 3", ILineCoverage.NO_CODE, lines.getCoverage(3));
  }

  public void testAfterLastLine() {
    lines.addLines(new int[] { 1 }, true);
    assertEquals("line 1000", ILineCoverage.NO_CODE, lines.getCoverage(1000));
  }
  ...
  public void testLineCoveredCovered() {
    lines.addLines(new int[] { 1003 }, true);
    lines.addLines(new int[] { 1003 }, true);
    assertEquals("total", 1, lines.getTotalCount());
    assertEquals("covered", 1, lines.getCoveredCount());
    assertEquals("line 1003", ILineCoverage.FULLY_COVERED,
        lines.getCoverage(1003));
  }
  ...
  public void testLineCoveredUncovered() {
    ...
    assertEquals("total", 1, lines.getTotalCount());
    assertEquals("covered", 1, lines.getCoveredCount());
    assertEquals("line 3", ILineCoverage.PARTLY_COVERED, lines.getCoverage(3));
  }
  ...
  public void testLineUncoveredUncovered() {
    ...
    assertEquals("line 3", ILineCoverage.NOT_COVERED, lines.getCoverage(3));
  }
  ...
  public void testScenario1() {
    ...
    assertEquals("line 10", ILineCoverage.FULLY_COVERED, lines.getCoverage(10));
    assertEquals("line 11", ILineCoverage.FULLY_COVERED, lines.getCoverage(11));
    assertEquals("line 12", ILineCoverage.FULLY_COVERED, lines.getCoverage(12));
    assertEquals("line 13", ILineCoverage.FULLY_COVERED, lines.getCoverage(13));
    assertEquals("line 14", ILineCoverage.FULLY_COVERED, lines.getCoverage(14));
  }
  ...
  public void testScenario2() {
    ...
    assertEquals("line 10", ILineCoverage.FULLY_COVERED, lines.getCoverage(10));
    assertEquals("line 11", ILineCoverage.FULLY_COVERED, lines.getCoverage(11));
    assertEquals("line 12", ILineCoverage.PARTLY_COVERED, lines.getCoverage(12));
    assertEquals("line 13", ILineCoverage.PARTLY_COVERED, lines.getCoverage(13));
    assertEquals("line 14", ILineCoverage.NOT_COVERED, lines.getCoverage(14));
  }
  ...
  public void testScenario3() {
    ...
    assertEquals("line 10", ILineCoverage.NOT_COVERED, lines.getCoverage(10));
    assertEquals("line 11", ILineCoverage.PARTLY_COVERED, lines.getCoverage(11));
    assertEquals("line 12", ILineCoverage.PARTLY_COVERED, lines.getCoverage(12));
    assertEquals("line 13", ILineCoverage.PARTLY_COVERED, lines.getCoverage(13));
    assertEquals("line 14", ILineCoverage.NOT_COVERED, lines.getCoverage(14));
  }
